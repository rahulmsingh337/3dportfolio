...
const ENTRIES = [
  ...
  {
    id: 3,
    title: "Prompify: Building an AI prompt optimisation app with Gemini API",
    category: "AI / Full-Stack",
    categoryColor: "#D8B4FE",
    readTime: "10 min read",
    date: "Jan 2026",
    icon: "🤖",
    href: "https://prompifytech.vercel.app",
  },
  {
    id: 4,
    title: "Clean Core in practice: Released APIs, side-by-side extensibility and what it means for custom ABAP",
    category: "Clean Core",
