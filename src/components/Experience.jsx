...
const JOBS = [
  {
    ...
    points:[
      "Leading SAP ABAP development and ECC to S/4HANA migration for global enterprise clients.",
      "HANA remediation on custom ABAP programs to ensure seamless S/4HANA compatibility.",
      "Developing and optimizing CDS Views, OData Services, and RAP-based applications.",
      "Collaborating with SmartShift team to build automation tools for SAP migration workstreams.",
      "Redesigning legacy programs for database performance optimization on SAP HANA.",
      "Code reviews, ATC, SQL Trace, ABAP Runtime Analysis, system dump analysis.",
    ],
    tech:["ABAP Cloud","S/4HANA","RAP","SmartShift","CDS Views","OData V4","Fiori"],
  },
  {
    company:"Infosys Private Limited", role:"SAP ABAP & Fiori Consultant",
    period:"May 2021 – Dec 2025", location:"Noida, UP", current:false,
    points:[
      "Infosys Certified SAP Fiori Consultant. Top performer in EAS SAP Unit.",
      "ALV/SALV reports, proxies, RFC, IDocs, Web Dynpro interface programs.",
      "SmartForms, Adobe Forms, SAPscript layouts for diverse business outputs.",
      "AMS Track Lead (Aug 2022 – Dec 2025): resolved P1/P2 incidents, led design discussions.",
      "Applied ABAP 7.5 techniques — inline declarations, ABAP SQL enhancements.",
      "16 consecutive INSTA Rewards · 5× Unit Rise Awards · Best Performer recognition.",
    ],
    tech:["SAP Fiori","Web Dynpro","ALE/IDocs","Adobe Forms","ABAP 7.5","BAPIs","SAP Workflow"],
  },
];
